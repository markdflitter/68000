...
extern "C" ide_result __ide_write (unsigned long LBA, unsigned char data [ide_block_size]);
extern "C" ide_result __ide_read (unsigned long LBA, unsigned char data [ide_block_size]);
