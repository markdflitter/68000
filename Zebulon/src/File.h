...
{
public:
	typedef mdf::shared_ptr <File> Ptr;
	typedef mdf::shared_ptr <const File> ConstPtr;

	File (FAT* fat = 0, const std::string& name = "", const std::list<Chunk::Ptr> chunks = std::list<Chunk::Ptr> ());
